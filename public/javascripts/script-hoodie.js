...
function rate() {
  ...
  if (color == "White") {
    tshirt_color = 40;
    document.getElementById("t-shirt-color").src="/images/White Hoodie.png";
  } else if (color == "Black") {
    tshirt_color = 30;
    document.getElementById("t-shirt-color").src="/images/Black Hoodie.png";
  } else if (color == "Blue") {
    tshirt_color = 50;
    document.getElementById("t-shirt-color").src="/images/Blue Hoodie.png";
  }
