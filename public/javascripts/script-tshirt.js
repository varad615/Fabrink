...
function rate() {
  ...
  if (color == "White") {
    tshirt_color = 40;
    document.getElementById("t-shirt-color").src="/images/White T-Shirt.png";
  } else if (color == "Black") {
    tshirt_color = 30;
    document.getElementById("t-shirt-color").src="/images/Black T-Shirt Mock.png";
  } else if (color == "Blue") {
    tshirt_color = 50;
    document.getElementById("t-shirt-color").src="/images/Blue T-Shirt.png";
  }
